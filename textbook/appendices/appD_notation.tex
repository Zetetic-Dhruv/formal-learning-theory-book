...
$\Ndim(\mathcal{H})$ & Natarajan dimension: multiclass generalization of VC via two-function shattering $(f_0, f_1)$.  Finite $\Ndim$ is sufficient but does \emph{not} characterize multiclass PAC learnability when $|Y| = \infty$; $\Ndim \leq \DSdim$, and $\DSdim$ is the characterizer. Macro: \verb|\Ndim|. & Ch.~17 \\
...
$\omega^\omega$ & The supremum of the finite powers $\omega, \omega^2, \omega^3, \ldots$. & Ch.~13 \\
