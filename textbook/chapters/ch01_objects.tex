...
\item The three standard model-selection principles---Bayesian, MDL, MML---form a triangle of near-miss analogies whose obstructions differ pair by pair, while a genuine theorem (PAC-Bayes) and a genuine equivalence (compression $\leftrightarrow$ finite VC, \cref{thm:compression-char}) sit nearby and are often confused with them.
\end{enumerate}

These patterns---hub nodes, negative results as content, analogy obstructions, and the discipline of separating what is proved from what is merely said---recur throughout the book.
