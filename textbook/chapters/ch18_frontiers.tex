...
\item \textbf{Machine-checked certificates.}  For the specific function class
  ...
  norm and is not yet non-vacuous on large models: it answers
  \Cref{op:deep-gen} on the axis of \emph{trust} rather than \emph{tightness},
  adding a kernel-audited guarantee, not a smaller number.
\end{itemize}
