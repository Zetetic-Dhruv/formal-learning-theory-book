...
\leanname{DSDim} is the \emph{all-labelings} dimension (every $f \colon S \to Y$
realizable), which satisfies $\DSdim \leq \Ndim$, the \emph{opposite} of the
real DS relationship.  Can the true DS dimension---default plus single-coordinate
