...
\label{op:mat-char}
Which classes are learnable from a minimally adequate teacher (\cref{def:mat}) in polynomial time? Beyond DFAs the picture is partial---decision trees, certain Boolean formulas, residual finite-state automata are known positive. Give a combinatorial characterization analogous to the VC dimension for PAC learning, or show the query model admits none.
\end{openprob}
