...
is known off the maximum case---an unknown known: the combinatorial object is in
...
resampling---changing one training example changes $O(1)$ of the selected
...
hypotheses containing a consistent one?  An unknown known---the multiclass
...
lower bound is known---a known unknown on the negative side of the ledger, and
