...
learnability through a web of nine equivalent conditions.
...
\end{scope}
\end{tikzpicture}
\caption[The equivalence web of the Fundamental Theorem: VC dimension as the hub]{Several a priori
unrelated descriptions of ``learnable'' collapse into one equivalence class, with finite VC dimension as
the central hub (\leanname{fundamental_theorem}). The single outside node, finite Littlestone dimension,
implies PAC learnability but the converse fails (thresholds on $\R$ have $\VC=1$ and $\Ldim=\infty$), the
one place where the equivalence breaks into the online separation of \Cref{ch:separations}.}
...
Each exercise adds, replaces, or refines one spoke of the equivalence web in \Cref{fig:equivalence-web}.
