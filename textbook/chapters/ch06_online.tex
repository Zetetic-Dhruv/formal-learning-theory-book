...
\end{itemize}
The \emph{depth} of the tree is the number of internal nodes on any root-to-leaf path (all paths have the same length since the tree is complete).\formal{FLT_Proofs.Complexity.Littlestone.MistakeTree.isShattered}
\end{defn}
